...
- The [`example/move/groth16_verifier`](example/move/groth16_verifier) directory contains a sample Sui Move smart contract for verifying SP1 proofs.
- The [`example/sp1_sui_sdk`](example/sp1_sui_sdk) directory contains a sample example using the Sui Rust SDK for verifying SP1 proofs with PTB (Programmable Transaction Blocks).
